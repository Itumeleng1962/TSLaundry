      ...
      <section className="container-x py-16 lg:py-24">
        <div className="mx-auto max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full" data-testid="faq-accordion">
              {FAQS.map((f, i) => (
                <AccordionItem key={i} value={`item-${i}`} className="border-line">
                  <AccordionTrigger className="text-left font-serif text-xl text-ink hover:text-gold hover:no-underline">{f.q}</AccordionTrigger>
          ...
          <Reveal className="mt-12 text-center">
            <p className="text-[#666666]">Still have questions?</p>
