    ...
    <section className="relative overflow-hidden bg-cloud pt-36 pb-16 lg:pt-44 lg:pb-20">
      <div className="container-x">
        <Reveal className="max-w-3xl">
          ...
          <h1 className="font-serif text-5xl font-light leading-[1.02] tracking-tight text-ink sm:text-6xl">{title}</h1>
          {lede && <p className="mt-6 max-w-xl text-lg leading-relaxed text-[#666666]">{lede}</p>}
          {children}
        </Reveal>
      </div>
    </section>
